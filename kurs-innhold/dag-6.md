...
Sharp har to begreper som hører sammen. Mental tilgjengelighet — som handler om merkets plass i hodet – og fysisk tilgjengelighet. Det handler om merkets plass i «butikken». At produktet faktisk er tilgjengelig, når vi tenker på å kjøpe det.

Verdens beste merkebygging hjelper lite om produktet ikke står i hylla. Verdens beste distribusjon hjelper lite om ingen tenker på merket. De to jobber sammen.
...
Distinkte markører er mer enn logo. Det kan være karakterer (svært populært i skrivende stund. Okser til supper, kuer til sjoko, Nilsner til leverpostei og syltetøy), farger, fonter, lydlogoer, formen på flaska, en bestemt måte å klippe en film på, en bestemt fortellerstemme, en pay off. Alt som over tid har festet seg som «merkets egne markør».
...
Bruk listen når du vurderer merkets visuelle og auditive uttrykk i en kampanje.

- [ ] Har vi distinkte merkemarkører som kunden kjenner igjen på under et sekund?
- [ ] Brukes de tydelig — eller bare som signatur til slutt?
- [ ] Bygger denne kampanjen videre på eksisterende merkemarkører, eller introduserer den nye uten god grunn?
- [ ] Er produktet faktisk fysisk tilgjengelig der mental tilgjengelighet skal omsettes til salg?
