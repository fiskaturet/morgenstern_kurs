...
related:
  - title: "Effectiveness in Context"
    meta: "Binet & Field, 2018 — kategoriutvidelser"
  - title: "Marketing in the Era of Accountability"
    meta: "Binet & Field, 2007 — den første IPA-rapporten"
prev:
  day: 3
  title: "60/40-regelen"
next:
...
Humor er emosjonelt. Skjønnhet er emosjonelt. Overraskelse er emosjonelt. Spenning er emosjonelt. Varme, irritasjon, gjenkjennelse, nostalgi, noe imponerende — alt dette er emosjonelt.

Det motsatte av emosjonelt er «argumenterende». Reklamen som forklarer at vaskemaskinen vasker 23 % renere enn forrige generasjon, er rasjonell. Reklamen som viser et barn som har blitt veldig møkkete, men at det ikke gjør noe, er emosjonell.

### Hvorfor emosjonell reklame virker bedre over tid
...
**Skillet er ikke glassklart.** En god reklame kan være både emosjonell og rasjonell. En film kan vise et morsomt, varmt øyeblikk og samtidig si noe konkret om produktet. Å tvinge alt inn i én av to bokser blir rart.

**Måling av «emosjonell vs rasjonell» er metodisk ganske vanskelig.** Klassifiseringen i IPA-databanken bygger på vurderinger av kampanjenes innhold, og forskjellige analytikere kan vurdere samme kampanje ulikt. Funnene er robuste på tvers av databasen, men enkeltkampanjer ikke alltid er like lette å plassere.
...
- [ ] Hva er hovedjobben til denne reklamen — bygge merket eller aktivere salg?
- [ ] Hvis det er merkebygging: skaper den en følelse, eller forklarer den et produkt?
- [ ] Hvis det er aktivering: er argumentet konkret nok til å gi noen en grunn til å handle nå?
- [ ] Hvis vi har valgt «emosjonell»: er følelsen distinkt, eller er det en standard slow motion-film alle kunne ha laget?
